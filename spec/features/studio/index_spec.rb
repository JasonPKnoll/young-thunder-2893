...
RSpec.describe 'the studio index' do
  before(:each) do
    ...
    @movie3 = studio.movies.create!(:title "Finding Nemo", :creation_year 2003, :genre "Adventure")
    @movie4 = studio.movies.create!(:title "Up", :creation_year 2009, :genre "Adventure")
  end
